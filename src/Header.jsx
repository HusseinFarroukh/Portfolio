    ...
    return (
        <div className="bg-black m-0 p-0">
            ...
            <div className="relative w-screen h-screen overflow-hidden">
                <video autoPlay muted loop src="/1.mp4" className="absolute top-0 left-0 w-full h-full object-cover"></video>
                ...
                <section className="absolute z-10 text-white text-center  p-4 bottom-10 left-1/2 transform -translate-x-1/2">
                    <div className="flex flex-col justify-center items-center">
                        ...
                        <a href="#about" ><img src="/arrow-down.png" width={30} alt=""  className="hover:scale-125 transition-all ease-in-out duration-300"/></a>
                            ...
                            <div className="bg-linear-to-b from-red-300 to-black-/0 opacity-25 h-30"></div>

                <div className="absolute inset-x-0 bottom-0 h-30 bg-linear-to-t from-red-300 to-black-500/0 opacity-17 pointer-events-none"></div>
